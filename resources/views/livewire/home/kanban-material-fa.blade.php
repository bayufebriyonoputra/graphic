    ...
    <script>
            ...
            $wire.on('materialFaUpdated', () => {
                ...
                var chart1 = new Chart(ctx1, {
                    type: 'bar',
                    data: {
                        labels: {!! json_encode($kanban['month']) !!},
                        datasets: [{
                            label: 'Series 1',
                            data: {!! json_encode($kanban->part_number) !!},
                ...
                var chart2 = new Chart(ctx2, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            label: 'Series 2',
                            data: {!! json_encode($kanban->part_address) !!},

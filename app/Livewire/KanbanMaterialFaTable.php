...
use App\Models\KanbanMaterialFa;
...
final class KanbanMaterialFaTable extends PowerGridComponent
{
    ...
    public function actions(KanbanMaterialFa $row): array
    {
        return [
            Button::add('delete')
            ->slot('Delete')
    ...
    #[On('confirmDelete')]
    public function clickToDelete(KanbanMaterialFa $kanban)
    {
    ...
    public function deleteKanban(){
        KanbanMaterialFa::destroy($this->kanbanId);
